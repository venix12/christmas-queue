    ...
    modal = () => {
        ...
        return (
            <Modal
                ...
                header={
                    <a class="beatmap-card__badge round-text text-left" href={`${osuBaseUrl}/beatmapsets/${beatmap_id}`}>
                        {metadata} <br />
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                >
                    <a class="beatmap-card__badge" href={`${osuBaseUrl}/beatmapsets/${beatmap_id}`}>
                        {metadata} <br />
